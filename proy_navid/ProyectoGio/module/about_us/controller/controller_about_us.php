 ...
 -->
    <div class="row">
        ...
        <div class="col-md-5 col-sm-6 col-xs-12">
            <div class="aboutus-banner">
                <img src="view/img/about_us/img1.png" alt="">
            </div>
        </div>
            ...
            <div class="feature">
                <div class="feature-box">
                    <div class="clearfix">
                        ...
                        <div class="feature-content">
                            <h4 class="lead">Work with heart</h4>
                            <p class="aboutus-text">Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in.</p>
                        </div>
                    </div>
                </div>
                <div class="feature-box">
                    <div class="clearfix">
                        ...
                        <div class="feature-content">
                            <h4 class="lead">Reliable services</h4>
                            <p class="aboutus-text">Donec vitae sapien ut libero venenatis faucibu. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt</p>
                        </div>
                    </div>
                </div>
                <div class="feature-box">
                    <div class="clearfix">
                        ...
                        <div class="feature-content">
                            <h4 class="lead">Great support</h4>
                            <p class="aboutus-text">Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in.</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
            <div class="col-md-5">
                ...
                <p class="lead ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto nihil consequatur voluptas veritatis et magni .! </p>
            </div>
            <div class="col-md-7">
                <p class="aboutus-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam.</p>
                <p class="aboutus-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam. Lorem ipsum dolor sit amet. Nulla convallis egestas rhoncus.</p>
            </div>
    </div>
    <br>
    <br>
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="aboutus-title">Our Team</h3>  
        </div>                      
    </div>
    <div class="row">
        <div class="col-md-4 team-box">
            <div class="team-img thumbnail">
                ...
                <div class="team-content">    
                    ...
                    <p class="aboutus-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam.</p>
    ...
    <div class="row">
        <div class="col-md-9 col-sm-9 col-xs-12">
            <h3><span class="glyphicon glyphicon-cog "></span> <b>Cars for sale?</b> Explore Vehicles like a pro.</h3>
        </div>
